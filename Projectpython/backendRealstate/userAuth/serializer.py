...
from .models import Role, User, Temoinage, Blog, Contact, RDV, Category, Service, Image, Property, PropertyInfo, ReviewStar
...
class PropertyInfoSerializer(serializers.ModelSerializer):
    class Meta:
        model = PropertyInfo
        fields = ['property_titre', 'property_description', 'property_surface', 'property_dispo', 'property_prix','image','category','service','localisation']
...
class LocationSerializer(serializers.ModelSerializer):
    class Meta:
        model = Localisation
        fields = ['id', 'emplacement', 'latitude', 'longitude']
class ProSerializer(serializers.ModelSerializer):

    class Meta:
        model = PropertyInfo
        fields = ['property_titre', 'property_surface', 'property_dispo', 'property_prix']
